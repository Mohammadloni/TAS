...
def main():
  ...
  if args.parallel:
    ...
    model = model.cuda()
  ter_op = ter_utils.TerOp(model, args)
  ...
  for epoch in range(args.epochs):
    ...
    train_acc, train_obj = train(train_queue, model, criterion, optimizer,optimizer_delta_w,optimizer_scailing_factor, ter_op, scheduler)
...
def train(train_queue, model, criterion, optimizer,optimizer_delta_w,optimizer_scailing_factor, ter_op, scheduler):
